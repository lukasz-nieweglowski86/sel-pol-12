...
class TestLitecartMainPage(unittest.TestCase):
    ...
    def test_registration(self):
        ...
        self.driver.find_element_by_name("tax_id").send_keys("")
        ...
        # self.driver.find_element_by_xpath("//input[@name='zone_code']").send_keys("lubelskie") #it's disabled, am i supposed to fill it?
        ...
        self.driver.find_element_by_xpath("//input[@name='newsletter']").click() #just click(), because i don't want newsletter
